...
// DCA 再有効化 (2026-05-30, user 指示「最大限利益、止めない、scam OK」)。
// 旧: HOLD時に買い続ける構造が "売れない bot" の主因 → 過去無効化
// 新: full scam mode で再起動、構造的に loss 加速する可能性高いが user 明示指示
const DCA_ENABLED = true;
